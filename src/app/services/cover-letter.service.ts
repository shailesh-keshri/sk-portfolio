...
export class CoverLetterService {
  private baseData: CoverLetterData = {
    ...
    content: [
      'I’m writing to express my interest in the Full-Stack Developer position at [Company Name]. Over the past 4 years, I’ve been focused on building enterprise-grade software for cybersecurity and education. I’ve developed a strong foundation in the Angular and .NET C# ecosystem, and I genuinely enjoy the process of turning complex requirements into reliable, user-friendly applications.',
      'In my current role at SISA Forensic-driven Cybersecurity, I’ve been a core contributor to ProAct, our Agentic SOC platform. I’ve had the chance to lead the development of key modules like Shift Handover and the Logstash Manager, where I was responsible for everything from the MySQL backend to the final UI. I take a lot of pride in seeing a feature through from the initial design phase to a successful production release.',
